...
<body>
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<spring:message code="student.detail.district.plhd"
				var="district_plhd" />
			...
			<form:form class="form-horizontal" action="./save" method="post"
				...
				<div class="form-group">
					<label class="control-label col-sm-4" for="fName"> <spring:message
							code="student.detail.fName" />
					</label>
					<div class="col-sm-6">
				...
				<div class="form-group">
					<label class="control-label col-sm-4" for="lName"> <spring:message
							code="student.detail.lName" />
					</label>
					<div class="col-sm-6">
				...
				<div class="form-group">
					<label class="control-label col-sm-4" for="age"> <spring:message
							code="student.detail.age" />
					</label>
					<div class="col-sm-6">
				...
				<div class="form-group">
					<label class="control-label col-sm-4" for="street"> <spring:message
							code="student.detail.street" />
					</label>
					<div class="col-sm-6">
				...
				<div class="form-group">
					<label class="control-label col-sm-4" for="district"> <spring:message
							code="student.detail.district" />
					</label>
					<div class="col-sm-6">
				...
				<div class="form-group">
					<label class="control-label col-sm-4" for="city"> <spring:message
							code="student.detail.city" />
					</label>
					<div class="col-sm-6">
